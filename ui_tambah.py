...
class AddWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # File name label
        self.file_name_label = QLabel("Belum ada gambar dipilih")
        ...
        # Open file button
        open_btn = QPushButton("Pilih Gambar")
        ...
        self.result_text.setPlaceholderText("Teks yang diekstrak akan muncul di sini")
    ...
    def simpan_data(self):
        if not self.path_gambar or not self.hasil_ekstraksi:
            QMessageBox.warning(self, "Peringatan", "Pilih gambar dan lakukan ekstraksi terlebih dahulu!")
            return
            
        # Save image to 'gambar' folder
        ...
        self.db.conn.execute(
            "INSERT INTO files (nama_file, lokasi_file, hasil_ekstraksi, tanggal) VALUES (?, ?, ?, ?)",
            (nama_file, lokasi_baru, self.hasil_ekstraksi, tanggal_input)
        )
        self.db.conn.commit()
